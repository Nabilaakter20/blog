                        ...
                        <div class="body">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <select name="categories[]" id="category" class="form-control show-tick selectpicker"  multiple>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('tags') ? 'focused error' : '' }}">
                                    ...
                                    <select name="tags[]" id="tag" class="form-control show-tick selectpicker" multiple>
                                        @foreach($tags as $tag)
